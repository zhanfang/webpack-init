...
var webpackConfig = merge(baseWebpackConfig, {
    ...
    plugins: [// http://vuejs.github.io/vue-loader/workflow/production.html
        ...
        new ExtractTextPlugin(utils.assetsPath('css/[name].[contenthash:6].css')), // generate dist index.html with correct asset hash for caching.
...
webpackConfig.plugins = webpackConfig.plugins.concat(utils.getHtmlWebpackPlugins(baseWebpackConfig.entry))
